...
INSERT INTO QCM (id, id_theme, id_supplier, name, description, is_validated, is_free, category,price,minimal_score, is_complete) values (101, 1, 101, 'Ligue 1',
'Un questionnaire pour tous les fans de l élite du football français', TRUE, TRUE, 'sommatif',0,0, TRUE);
INSERT INTO QCM (id, id_theme, id_supplier, name, description, is_validated, is_free, category,price,minimal_score, is_complete) values (102, 2, 102, 'Max et Léon',
'Un questionnaire pour tous les fans du Palma Show', TRUE, TRUE, 'sommatif',0,0, TRUE);
INSERT INTO QCM (id, id_theme, id_supplier, name, description, is_validated, is_free, category,price,minimal_score, is_complete) values (103, 3, 103, 'B2oba',
...
INSERT INTO QUESTION (id, id_qcm, title, answer, proposition1, proposition2, proposition3, question_number) values (106, 103,
 'En quelle année le rappeur est-il né ?', '1976', '1986', '1982', '1978','1');
